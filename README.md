...
1. Создал две VM в Yandex Cloud с параметрами: 2CPU 4RAM Centos7. Для создания использовал Terraform, ссылка на код:
2. Прописал в [inventory](./infrastructure/inventory/cicd/hosts.yml) созданные хосты.
